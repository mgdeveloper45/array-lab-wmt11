...
const lastItem = sampleArray.length-1;
console.log(lastItem); // 7
...
sampleArray.push(42);
console.log(sampleArray); // [2, 4, 6, 8, 10, 12, 1, 3, 5,  7, 42]
//////////////////PROBLEM 5////////////////////
...
const removeLastNum = sampleArray.pop();
console.log(removeLastNum); // 42
console.log(sampleArray); // [2, 4, 6, 8, 10, 12, 1, 3, 5, 7]
//////////////////PROBLEM 6////////////////////
...
console.log(sampleArray); // [42, 4, 6, 8, 10, 12, 1, 3, 5, 42]
